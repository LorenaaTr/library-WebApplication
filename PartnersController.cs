...
namespace Server.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PartnerId,BussinessName,CeoName,email,City,books")] Partners partners)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartnerId,BussinessName,CeoName,email,City,books")] Partners partners)
        {
